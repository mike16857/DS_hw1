...
public:
    ...
    ~MatrixWDigraph(){}
    void SetWeight(int u, int v, int wei)
        {length[u][v] = wei;}
    void SetupG1();
    void SetupG1i();
    void SetupG1ii();
    ...
    void PrintAllLengths(const int n);
private:
...
void MatrixWDigraph::PrintAllLengths(const int n)
{
...
int main()
{
    ...
    cout << "G1':\n";
    g1i.SetupG1i();
    g1i.ShortestPath(6, 0);
    cout << endl;
    //-----------------------------------------------------------
    cout << "G1'':\n";
    g1ii.SetupG1ii();
    g1ii.ShortestPath(6, 0);
